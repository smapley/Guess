...
import com.smapley.guess.activity.Add;
import com.smapley.guess.adapter.ProItem3Adapter;
...
import com.smapley.guess.http.service.FolderListService;
...
public class Pro_Item3 extends BaseFragment {
    ...
    private FolderListService folderListService=new FolderListService() {
        @Override
    ...
    public void getDataForWeb() {
        folderListService.load(userBaseEntity,pro_id);
    }
