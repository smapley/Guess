...
import com.smapley.guess.http.params.AccountParams;
import com.smapley.guess.http.params.BaseParams;
import com.smapley.guess.http.callback.HttpCallBack;
...
//                }
    ...
    private void saveData() {
        AccountParams params=new AccountParams(userBaseEntity);
        params.setTruename(acc_et_name.getText().toString());
        params.setPhone(acc_et_phone.getText().toString());
        params.setBirthday(DateUtil.getDateLong(acc_tv_birthday.getText().toString(), DateUtil.formatDate));
