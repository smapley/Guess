...
import com.smapley.guess.activity.Achievement;
import com.smapley.guess.activity.NoteList;
import com.smapley.guess.activity.Setting;
import com.smapley.guess.activity.TaskList;
import com.smapley.guess.mode.Per_Group_Mode;
    ...
    public void setData(final Context context, final Per_Group_Mode mode) {
        ...
        contentView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                switch (mode.getItem()) {
                    case 1:
                        context.startActivity(new Intent(context, TaskList.class));
                        break;
                    case 2:
                        context.startActivity(new Intent(context, NoteList.class));
                        break;
                    case 3:
